    ...
    <div className="mx-auto max-w-2xl space-y-4">
      ...
      <div className="space-y-3">
        {ticket.messages.map((m: { id: string; senderRole: string; body: string }) => (
          <div key={m.id} className={`max-w-[80%] rounded-control p-3 text-sm ${m.senderRole === "ADMIN" ? "ml-auto border border-primary/25 bg-primary/10" : "border border-outline-variant bg-surface-container-high"}`}>
