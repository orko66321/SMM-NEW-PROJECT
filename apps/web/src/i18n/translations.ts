...
const en = {
  ...
  referEarn: {
    ...
    subtitleGeneric: "Invite friends and earn a commission every time they top up their wallet.",
    linkCtaTitle: "Your unique referral link",
    yourLink: "Your referral link",
    copyLink: "Copy link",
    codeLabel: "Your code: {{code}}",
    shareVia: "Share via",
    shareMessage: "Join All In One and get a bonus on your first deposit — sign up with my link:",
    shareWhatsapp: "Share on WhatsApp",
    shareFacebook: "Share on Facebook",
    shareTwitter: "Share on X",
    shareTelegram: "Share on Telegram",
    totalInvited: "Referred users",
    totalEarnings: "Referral earnings",
    pendingReferrals: "Awaiting deposit",
    conversionRate: "Conversion rate",
    stepsTitle: "How it works",
    step1Title: "Share your link",
    step1Body: "Send your referral link to friends, groups, or your audience.",
    step2Title: "They sign up & deposit",
    step2Body: "Your friend creates an account and makes their first wallet top-up.",
    step3Title: "Earn instantly",
    step3Body: "Your commission lands in your wallet the moment their deposit clears.",
  ...
  newOrder: {
    ...
    rulesTitle: "Service Details & Rules",
  ...
  tickets: {
    ...
    orderIdsHint: "The Order ID(s) shown on your Order History page (e.g. 10023) — comma-separated, you can list more than one.",
...
const bn: Translations = {
  ...
  referEarn: {
    ...
    subtitleGeneric: "বন্ধুদের ইনভাইট করুন — তারা প্রতিবার ওয়ালেটে টাকা যোগ করলেই আপনি কমিশন পাবেন।",
    linkCtaTitle: "আপনার নিজস্ব রেফারেল লিংক",
    yourLink: "আপনার রেফারেল লিংক",
    copyLink: "লিংক কপি করুন",
    codeLabel: "আপনার কোড: {{code}}",
    shareVia: "শেয়ার করুন",
    shareMessage: "All In One-এ জয়েন করুন আর প্রথম ডিপোজিটে বোনাস পান — আমার লিংকে সাইন আপ করুন:",
    shareWhatsapp: "WhatsApp-এ শেয়ার করুন",
    shareFacebook: "Facebook-এ শেয়ার করুন",
    shareTwitter: "X-এ শেয়ার করুন",
    shareTelegram: "Telegram-এ শেয়ার করুন",
    totalInvited: "রেফার করা ইউজার",
    totalEarnings: "রেফারেল আয়",
    pendingReferrals: "ডিপোজিটের অপেক্ষায়",
    conversionRate: "কনভার্সন রেট",
    stepsTitle: "যেভাবে কাজ করে",
    step1Title: "লিংক শেয়ার করুন",
    step1Body: "আপনার রেফারেল লিংক বন্ধু, গ্রুপ বা আপনার অডিয়েন্সের কাছে পাঠান।",
    step2Title: "তারা সাইন আপ ও ডিপোজিট করে",
    step2Body: "আপনার বন্ধু অ্যাকাউন্ট খুলে প্রথমবার ওয়ালেটে টাকা যোগ করে।",
    step3Title: "সঙ্গে সঙ্গে আয়",
    step3Body: "তাদের ডিপোজিট সম্পন্ন হওয়ামাত্র আপনার কমিশন ওয়ালেটে চলে আসে।",
    activityTitle: "সাম্প্রতিক রেফারেল কার্যক্রম",
  ...
  newOrder: {
    ...
    rulesTitle: "সার্ভিস বিবরণী ও নির্দেশাবলী",
  ...
  tickets: {
    ...
    orderIdsHint: "আপনার অর্ডার হিস্ট্রি পেজে দেখানো অর্ডার আইডি (যেমন 10023) — কমা দিয়ে আলাদা করে একাধিক অর্ডার আইডি দেওয়া যাবে।",
    messageLabel: "মেসেজ",
    subjectLabel: "বিষয়",
