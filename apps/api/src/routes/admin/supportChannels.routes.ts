...
import { SupportChannelTypeValues, supportChannelUpdateSchema, type SupportChannelType } from "@smm/shared";
...
adminSupportChannelsRouter.get(
  "/",
...
adminSupportChannelsRouter.put(
  "/:type",
  validate(supportChannelUpdateSchema),
  asyncHandler(async (req, res) => {
    const type = req.params.type as SupportChannelType;
    if (!SupportChannelTypeValues.includes(type)) throw AppError.notFound("Unknown support channel");
