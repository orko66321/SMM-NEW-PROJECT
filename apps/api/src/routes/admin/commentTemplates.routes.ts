...
} from "../../services/commentTemplate.service.js";
import { writeAuditLog } from "../../services/audit.service.js";

export const adminCommentTemplatesRouter = Router();

adminCommentTemplatesRouter.get(
  "/",
...
adminCommentTemplatesRouter.post(
  "/",
  validate(commentTemplateInputSchema),
...
adminCommentTemplatesRouter.put(
  "/:id",
  validate(commentTemplateInputSchema.partial()),
  asyncHandler(async (req, res) => {
...
adminCommentTemplatesRouter.delete(
  "/:id",
  asyncHandler(async (req, res) => {
