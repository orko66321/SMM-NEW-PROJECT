...
import {
  ...
  createStockPool,
  deleteStockPool,
  listStockCodesForAdmin,
  listStockPoolsForAdmin,
  revokeStockCode,
} from "../../services/stockPool.service.js";
import { writeAuditLog } from "../../services/audit.service.js";

export const adminStockPoolsRouter = Router();

adminStockPoolsRouter.get(
  "/",
...
adminStockPoolsRouter.post(
  "/",
  validate(stockPoolInputSchema),
  asyncHandler(async (req, res) => {
...
adminStockPoolsRouter.post(
  "/:id/codes",
  validate(stockPoolBulkAddSchema),
  asyncHandler(async (req, res) => {
