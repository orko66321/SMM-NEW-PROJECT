...
function profitString(charge: Prisma.Decimal | null | undefined, cost: Prisma.Decimal | null | undefined) {
...
const LIKE_ORDER_FILTER = {
  service: { category: { name: { contains: "Like", mode: "insensitive" as const } } },
};
