...
import type { CreateSmsCampaignInput } from "@smm/shared";
...
async function resolveRecipients(
  targetGroup: CreateSmsCampaignInput["targetGroup"],
...
export async function getAudienceCounts(): Promise<{ all: number; vip: number; reseller: number }> {
 ...
 */
export async function createCampaign(sentById: string, input: CreateSmsCampaignInput) {
