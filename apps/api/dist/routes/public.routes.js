...
publicRouter.get("/posts", validate(publicPostListQuerySchema, "query"), asyncHandler(async (req, res) => {
...
publicRouter.get("/services", validate(serviceListQuerySchema, "query"), asyncHandler(async (req, res) => {
