...
adminBannersRouter.post("/", validate(bannerInputSchema), asyncHandler(async (req, res) => {
...
adminBannersRouter.put("/:id", validate(bannerInputSchema.partial()), asyncHandler(async (req, res) => {
